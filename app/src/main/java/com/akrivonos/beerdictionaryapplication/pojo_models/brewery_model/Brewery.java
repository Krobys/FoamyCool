...
public class Brewery {
    ...
    @SerializedName("brewersAssociation")
    @Expose
    private BrewersAssociation brewersAssociation;
    ...
    public BrewersAssociation getBrewersAssociation() {
        return brewersAssociation;
    }

    public void setBrewersAssociation(BrewersAssociation brewersAssociation) {
